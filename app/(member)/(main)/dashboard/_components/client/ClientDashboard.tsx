...
export default function ClientDashboard() {
  ...
  return (
    <Card className="w-full min-h-[79vh] flex flex-col gap-5">
        ...
        <div className="flex justify-between items-end">
          ...
          <div className="flex gap-3">
            <div className="border border-[#ccc] rounded-md px-4 flex items-center gap-1 cursor-pointer h-12">
              <PiUploadSimple className="text-[18px] pt-[1px]" /> 엑셀
              업로드(대량 등록)
            </div>
            <div className="bg-[#000] text-white rounded-md px-4 flex items-center gap-2 cursor-pointer h-12">
              <LuGoal className="text-[18px]" /> 미션 등록하기{" "}
              <IoIosArrowRoundForward className="text-[18px] ml-1" />
            </div>
          </div>
        </div>
        <div className="flex justify-between items-end">
